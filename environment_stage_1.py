...
world = False
if world:
    from scripts.respawnGoal_custom_worlds import Respawn
else:
    from scripts.respawnGoal import Respawn
import copy
...
class Env():
    ...
    def getState(self, scan, past_action):
        ...
        obstacle_index = np.argmin(scan_range)
        ...
        return scan_range + [heading, current_distance], done, self.get_goalbox
    ...
    #     self.goal_distance = self.getGoalDistace()
    #     state,done, goal= self.getState(data, [0]*self.action_dim)
